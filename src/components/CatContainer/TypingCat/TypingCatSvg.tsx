...
interface TypingCatSvgProps {}

const TypingCatSvg: FC<TypingCatSvgProps> = (props: TypingCatSvgProps) => {
  const {} = props;
  return (
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 783.55 354.91">
        <g id="bongo-cat">
          ...
          <g className="table">
            ...
            <line x1='25.3' y1='158.5' x2='783.2' y2='293' fill='none' stroke='#8d00fc' strokeMiterlimit='10'
                  strokeWidth='4' />
          ...
          <polygon className="laptop-cover" />
          ...
          <g className="headphone headpone-left">
            <g className="speaker">
              <path
